...
New-AzureResourceGroup -Name 'AzureCloudManager' -TemplateFile '..\Templates\WebSiteSQLDatabase.json' -TemplateParameterFile '..\Templates\WebSiteSQLDatabase.param.dev.json' -Force -Verbose
